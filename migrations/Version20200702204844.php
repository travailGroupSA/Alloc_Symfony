 ...
 */
final class Version20200702204844 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE etudiant (id INT AUTO_INCREMENT NOT NULL, chambre_id INT DEFAULT NULL, matricule VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, birthday DATE NOT NULL, boursier INT DEFAULT NULL, type_bourse VARCHAR(255) DEFAULT NULL, est_loge INT DEFAULT NULL, date_inscription DATE NOT NULL, adresse VARCHAR(255) DEFAULT NULL, INDEX IDX_717E22E39B177F54 (chambre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
